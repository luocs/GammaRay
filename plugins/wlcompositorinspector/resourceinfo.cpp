...
public:
  ...
  {
    m_infoExtractors[&wl_surface_interface] = wlsurfaceInfo;
    m_infoExtractors[&wl_shell_surface_interface] = wlshellsurfaceInfo;
    m_infoExtractors[&wl_output_interface] = wloutputInfo;
  }
  ...
  QHash<const wl_interface *, Function> m_infoExtractors;
};
